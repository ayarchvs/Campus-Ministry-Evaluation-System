            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Old $Event_Type ($Year/$Month/$day)</h1>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="input-group mb-4">
                                        ...
                                        <input type="text" class="form-control" value="Christian" disabled>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group mb-5">
                                        ...
                                        <input type="text" class="form-control" value="Lantaka, Adzu something yes adress :3 " disabled>
                                    </div>
                                </div>
