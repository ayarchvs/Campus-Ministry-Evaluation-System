                            ...
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="php/register-staff.php" method="POST" enctype="multipart/form-data">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                            ...
                                            <div class="input-group mb-3">
                                                    ...
                                                    <input class="form-control" id="inputEmail" name="inputEmail" type="text" placeholder="*Enter staff id" />
                                                    <!-- <label for="inputEmail">ADZU Email address</label> -->
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid"><button class="btn btn-primary btn-block" type="submit" name="createAccBtn">Create Account</button></div>
                                            </div>
                                        </form>
