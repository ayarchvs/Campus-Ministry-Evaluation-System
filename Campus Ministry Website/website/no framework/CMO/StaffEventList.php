                ...
                <tbody>
                    <?php
                        ...
                        while($row = mysqli_fetch_assoc($result)){
                            if($input1 = $row['E_Name'] && $input2 = $row['E_Year'] && $input3 = $row['E_Month'] && $input4 = $row['E_Day'] && $input5 = $row['E_Religion'] && $input6 = $row['E_Location']){
                                echo
                            '<tr>
                                <td>' .$row['id']. '</td>
                                <td>' .$row['E_Name']. '</td>
                                ...
                                <td>
                                    <a href = "view.php?upid= '.$row['id'].'"> View </a>
                                </td>

                                <td>
                                    <a href = "update.php?upid= '.$row['id'].'"> Update </a>
                                </td>

                                <td>
                                    <a href = "delete.php?delid= '.$row['id'].'"> Delete </a> 
                                </td>
                            </tr>';
                            }
                        }
